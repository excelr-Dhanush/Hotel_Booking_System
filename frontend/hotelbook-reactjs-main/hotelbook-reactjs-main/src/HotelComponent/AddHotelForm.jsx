...
const AddHotelForm = () => {
  ...
  useEffect(() => {
    const getAllHotelUsers = async () => {
      const response = await axios.get("http://localhost:8080/api/user/hotel");
      if (response.data) {
        setHotelUsers(response.data.users);
      }
    };
    getAllHotelUsers();
  }, []);
  ...
  const handleFileChange = (e) => {
    ...
    if (name === "image1") setSelectedImage1(files[0]);
    if (name === "image2") setSelectedImage2(files[0]);
    if (name === "image3") setSelectedImage3(files[0]);
    if (name === "image4") setSelectedImage4(files[0]);
  };
          ...
          <div className="register-center">
            ...
            <form onSubmit={saveHotel}>
              <div className="register-input-div flex-inputs">
                ...
                <div className="column">
                  <select onChange={handleInput} name="locationId">
                    <option value="">Select Location</option>
                    {locations.map((location) => (
              ...
              <div className="register-input-div flex-inputs">
                ...
                <div className="column">
                  <select onChange={handleInput} name="userId">
                    <option value="">Select Hotel Manager</option>
                    {hotelUsers.map((hotelUser) => (
